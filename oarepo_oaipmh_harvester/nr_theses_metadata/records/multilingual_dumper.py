...
class MultilingualDumper(SearchDumperExt):
    ...
    def dump(self, record, data):
        paths = [
            "/metadata/properties/abstract",
            "/metadata/properties/methods",
            "/metadata/properties/technicalInfo",
            "/metadata/properties/accessibility",
            "/metadata/properties/additionalTitles/items/properties/title",
            "/metadata/properties/subjects/items/properties/subject",
        ]
