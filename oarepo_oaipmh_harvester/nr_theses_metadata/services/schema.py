...
class ContributorsSchema(
    ...
    role = ma_fields.Nested(NRVocabularySchema)
...
class EventLocationSchema(
    ...
    country = ma_fields.Nested(NRVocabularySchema)
...
class NrThesesMetadataMetadataSchema(
    ...
    resourceType =ma_fields.Nested(NRVocabularySchema)
    ...
    accessRights = ma_fields.Nested(NRVocabularySchema)
    ...
    languages = ma_fields.List(ma_fields.Nested(NRVocabularySchema, dump_only=False), dump_only=False)

    notes = ma_fields.List(ma_fields.String())

    rights = ma_fields.List(ma_fields.Nested(NRVocabularySchema))
...
class NrThesesMetadataSchema(
    ...
    created = ma_fields.Date(dump_only=False)

    updated = ma_fields.Date(dump_only=False)
